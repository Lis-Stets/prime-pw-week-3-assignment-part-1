...
let favoriteFoods = [ 'cheese', 'pizza', 'fries', 'chocolate', 'olives' ];
...
console.log( 'removed the fist food item', removedFood );
console.log( 'My favorite foods are now', favoriteFoods );

// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods[1] = 'nachos'
console.log( 'My favorite foods are really', favoriteFoods );

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
favoriteFoods.sort();
console.log( 'alphabatized:', favoriteFoods );
favoriteFoods.reverse();
console.log( 'reverse alphabatized:', favoriteFoods );
...
let aFewOfMyFavoriteThings = [favoriteFoods + animalArray];
console.log( 'These are a few of my favorite things',  aFewOfMyFavoriteThings );
console.log( 'I lied, I do not like cheesefish.')
aFewOfMyFavoriteThings = [favoriteFoods + "," + animalArray];
console.log('These are a few of my favorite things',  aFewOfMyFavoriteThings );
